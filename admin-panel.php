...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"> </i> Revive </a>
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-8">
                    ...
                    <select name="apptime" class="form-control" id="apptime" required="required">
                      ...
                      <option value="08:00:00">3:00 AM</option>
                      ...
                      <tr>
                        ...
                        <td>
                          <form method="get">
                              ...
                              <input type = "submit" onclick="alert('Don\'t postpone your health, make it a priority today :) ');" name ="generate" class = "btn btn-success" value="Finish"/>
                              </a>
                              </td>
                              </form>
