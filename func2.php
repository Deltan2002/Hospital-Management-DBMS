...
if(isset($_POST['patsub1'])){
  ...
  $query12 = "select * from patreg where  email = '$email';";
  $result12=mysqli_query($con,$query12);
    ...
    if($result){
        ...
        $semail = $_POST['email']; 
        $query1 = "select * from patreg where  email = '$semail';";
    ...
    if(mysqli_num_rows($result1)==1){
      ...
      echo "<script>alert('PID is not stored "+mysqli_num_rows($result1)+"');</script>";
